...
s20 = pd.concat((pd.read_csv(dir+'Solar/Modelled/pasadena_2018_1h_367mods_s20.csv',index_col=0,parse_dates=True),
                 pd.read_csv(dir+'Solar/Modelled/pasadena_2019_1h_367mods_s20.csv',index_col=0,parse_dates=True)))

w90 = pd.concat((pd.read_csv(dir+'Solar/Modelled/pasadena_2018_1h_367mods_w90.csv',index_col=0,parse_dates=True),
                 pd.read_csv(dir+'Solar/Modelled/pasadena_2019_1h_367mods_w90.csv',index_col=0,parse_dates=True)))
...
output_filename = 'Output/caltech_ev_mjw5__output__'+tic.strftime('%y-%m-%d_%H-%M-%S')+'.csv'
...
for angle in ['s20','w90']:#,'s20, w20','w90','s20w90']:
    for batt_kwh in [50,100,200,400,600,800,1000,1200,1400,1600,1800,2000,2500,3000,4000,5000]:#[200,300,400,500,600,700,800,900,1000]:
